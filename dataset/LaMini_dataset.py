...
def load_LaMini_train(data_path, tokenizer, debug=False):
    ...
    dataset.save_to_disk(f"out/cache/Lamini-llama3.2-clean")
...
if __name__ == "__main__":
    lamini_data_path = "/node1/public/dataset/LaMini-instruction"
    tokenizer = AutoTokenizer.from_pretrained("/node1/public/model_weight/Llama3.2/Llama-3.2-3B")
    if not tokenizer.pad_token_id:
        tokenizer.pad_token_id = tokenizer.eos_token_id

    # load_LaMini_train(lamini_data_path, tokenizer, debug=False)
    max_length=1024 #6144 5120 4096 3072

    dataset = load_from_disk("/home/zhuyj/Prune/code/out/cache/Lamini-llama3.2-clean")
