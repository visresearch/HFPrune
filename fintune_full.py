...
from cfg.prune_llama import packed_ft_llama_Lamini_config
...
def main(config):
    ...
    len=1024
    dataset = PackedDataset(dataset, tokenizer=tokenizer, max_input_length=len, pack_length=len, cache=f"{dataset_path}/data_dict.json")
